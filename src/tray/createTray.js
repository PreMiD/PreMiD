...
exports.run = () => {
  constants.tray = new Tray(path.join(__dirname, "../assets/images/icon.png"))
  constants.tray.setToolTip(`YT Presence V${VERSIONSTRING}`)
  ...
  constants.tray.setContextMenu(constants.menuBarMenu)
}
