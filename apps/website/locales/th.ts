...
export default defineI18nLocale(() => ({
  ...
  component: {
    ...
    donationModal: {
      ...
      description: "เราหวังว่าคุณจะหลงรัก PreMiD! ถ้ามันทำให้คุณยิ้มได้ ทำไมไม่ลองส่งความรักกลับมาบ้างล่ะ? ทีมอาสาสมัครของพวกเราทุ่มเทสร้างมันขึ้นมาเพื่อคุณโดยเฉพาะ!",
  ...
  page: {
    ...
    home: {
      ...
      subtitle: "โม้เพื่อนๆของคุณว่าคุณกำลังสนุกกับ {word} อะไรอยู่",
      words: {
        music: "เพลง",
        videos: "วีดีโอ",
        streams: "สตรีม",
