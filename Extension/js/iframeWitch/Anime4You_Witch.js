$(document).ready(function() {
  setInterval(function() {
    if(document.location.hostname == "mysembed.net" || document.location.hostname == "www.rapidvideo.com" || document.location.hostname == "fruithosts.net" || document.location.hostname == "vidoza.net" || document.location.hostname == "oload.fun" || document.location.hostname == "streamango.com" || document.location.hostname == "openload.co") {
