...
export default {
  ...
  mounted(){
    ...
    sty.innerHTML = "#content,#header{transition:all 0.2s ease;}html,body{overflow-x: hidden;max-width:100vw;}.dark{background-color:#1a1a1a;color:#fff;}h1{color:#7289da;}";
